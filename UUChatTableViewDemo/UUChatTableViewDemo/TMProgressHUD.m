...
+ (TMProgressHUD *)sharedView {
    static dispatch_once_t once;
    static TMProgressHUD *sharedView;
    dispatch_once(&once, ^ {
        sharedView = [[TMProgressHUD alloc] initWithFrame:[[UIScreen mainScreen] bounds]];
...
+ (void)changeSubTitle:(NSString *)str {
    [[TMProgressHUD sharedView] setState:str];
}
...
+ (void)dismissWithSuccess:(NSString *)str {
    [[TMProgressHUD sharedView] dismiss:str];
}
