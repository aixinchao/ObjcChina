...
#define ChatContentTop 15   //文本内容与按钮上边缘间隔35
#define ChatContentLeft 25  //文本内容与按钮左边缘间隔10
#define ChatContentBottom 15 //文本内容与按钮下边缘间隔10
#define ChatContentRight 15 //文本内容与按钮右边缘间隔22
